...
<template>
	<article id="presentation">
		...
		<p class="indent-4 text-justify">
			Bien sur, même si j'aime beaucoup le développement, je ne fais pas que cela. Et comme j'aime bien apprendre de nouvelles choses, je me suis mis à la guitare il y a quelques années, puis à la basse quelques mois ensuite. Je dessine, fais de la MAO (Musique Assistée par Ordinateur), j'ai fait du rugby, je joue au flipper, je couds et surtout je lis beaucoup, autant des livres que des articles ou de la documentation sur internet. Je me suis aussi récemment lancé avec des amis dans le modélisme.
		</p>
	</article>
</template>
